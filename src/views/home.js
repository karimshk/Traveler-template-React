      ...
      <section className="home-hero">
        <div className="home-main">
          <div className="home-video">
            <video
              src
              poster="https://images.unsplash.com/photo-1600714480856-dc99b28892eb?ixid=M3w5MTMyMXwwfDF8c2VhcmNofDJ8fHRvdXIlMjBndWlkZXxlbnwwfHx8fDE2ODM5MDA3MzZ8MA&amp;ixlib=rb-4.0.3&amp;h=1500"
          ...
          <div className="home-content">
            <header data-thq="thq-navbar" className="home-navbar">
              <img
                alt="logo"
                src="/playground_assets/live-virtual-world-red1-200h.png"
                className="home-logo"
              />
            ...
            <div className="home-center">
              <div className="home-heading">
                <h1 className="home-header">
                  ...
                  <br></br>
                  <span>A World With No Borders</span>
                  <br></br>
                </h1>
                <p className="home-caption">
                  <span className="home-text11">Find a local guide</span>
                  <span>
                    <span
        ...
        <div id="features" className="home-feaures">
          <div className="home-content01">
            <Feature Description="Experience live, interactive, and culturally immersive virtual tours with Live Virtual World. Engage directly with expert guides at each destination for an authentic and personalized journey. No extra equipment required, just join us for a remarkable experience."></Feature>
            <Feature
              Icon="/playground_assets/headset.svg"
              Header="24/7 Support"
              Description="24/7 support for all your needs. Our dedicated team is here to assist you anytime, anywhere."
            ></Feature>
            <Feature
              Icon="/playground_assets/person.svg"
              Header="Private Tours"
              Description="Discover the world on your terms with our private tours. Tailored to your preferences and led by expert guides, experience destinations like never before in an exclusive and personalized setting."
            ></Feature>
          </div>
        </div>
      </section>
      <section id="tours" className="home-quick-view">
          ...
          <div className="home-heading01">
            ...
            <p className="home-caption01">
              <span className="home-text13">
                Uncover captivating destinations, guided by experts. Book your
                virtual tour today and embark on an unforgettable adventure from
                home.
              </span>
        ...
        <div className="home-pagination">
          <button className="home-previous button-option button">
            ...
            <span className="home-text19">Previous</span>
          </button>
          <div className="home-pages">
            <div className="home-primary">
              ...
              <div className="page">
                <span className="home-text21">2</span>
              </div>
              <div className="page home-number1">
                <span className="home-text22">3</span>
              </div>
            </div>
            <img
              alt="image"
            ...
            />
            <div className="page">
              <span className="home-text23">12</span>
            </div>
          </div>
          <button className="home-next button-option button">
            <span className="home-text24">Next</span>
        ...
        <div className="home-content02">
          <div className="home-heading02">
            <p className="home-quote">
              <span>
                &quot;Live Virtual World provided an incredible virtual tour
                experience! The guide was knowledgeable, engaging, and made me
                feel like I was truly there. I highly recommend their tours to
                anyone seeking to explore the world from the comfort of their
                own home.&quot;
              </span>
              <br></br>
            </p>
          ...
          <div className="home-details">
            <div className="home-author">
              <img
                alt="image"
                src="/playground_assets/my%20photo-200h.jpeg"
                className="home-avatar"
              />
              <span className="home-name">
                <span className="home-text27">Mohammad Ali </span>
                <br></br>
                <span>COO-Live Virtual World </span>
                <br></br>
              </span>
            </div>
        ...
        <div className="home-highlight">
          <div className="home-content03">
            ...
            <button className="button-arrow button">
              <span className="home-text33">Read more</span>
      ...
      <section className="home-footer">
        <div className="home-content12">
          <div className="home-main2">
            <div className="home-branding">
              <div className="home-heading10">
                <img
                  alt="Logo"
                  src="/playground_assets/live-virtual-world-red-200h.png"
          ...
          <span className="home-copyright">
            © 2023 Live Virtual World . All Rights Reserved.
          </span>
        </div>
      </section>
      <div>
